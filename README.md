...
$application_type   | The type/name of the application used to get the Token ("SendSecure PHP" will be used by default if empty)
...
Can be created either with a [File Path](#filepath) or a [Stream](#stream).
All attributes are mandatory.
